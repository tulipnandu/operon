...
open  my $protIds, '/users/tulip_nandu/desktop' or die 'Couldn\'t open file!';
...
my @domainIds = $xp->findnodes('//matches/match/@id');
my ($prot_desc) = $xp->findnodes('//entry/description/text()');
